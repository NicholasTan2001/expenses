...
export default function Transportation() {
    ...
    const submit = (e) => {
        ...
        post(route('transportation.store'), {
            onSuccess: () => {
                                    ...
                                    <form onSubmit={submit}>
                                        <div className="flex flex-wrap gap-5">
                                            <div className="mb-2 items-center">
                                                <InputLabel htmlFor="transport" value="Transport Name" className="w-32" />
                                                <TextInput
                                                id="transport"
                                                type="text"
                                                name="transport"
                                            ...
                                            <div className="mb-2 items-center">
                                                <InputLabel htmlFor="place" value="Place" className="w-32" />
                                                <TextInput
                                                id="place"
                                                type="text"
                                                name="place"
                                            ...
                                            <div className="mb-2  items-center gap-2">
                                                <InputLabel htmlFor="total_price" value="Total Price (RM)" className="w-32" />
                                                <TextInput
                                                    id="total_price"
                                                    type="number"
                                                    step="0.01"
                    ...
                    <div className="mx-auto max-w-5xl sm:px-6 lg:px-8 mb-9">
                        <div className="overflow-hidden bg-white shadow-md sm:rounded-lg">
                            <div className="p-6 text-gray-900 font-bold text-lg flex justify-between items-center">
                                <span>Total Expenses (Today) on Transportation:</span>
